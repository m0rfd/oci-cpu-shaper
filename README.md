...
The workflow pins Cosign to `v2.4.2` via `sigstore/cosign-installer` so the signing and verification flags below stay stable across releases; adjust the pin when upgrading Cosign.
