...
- Follow the repo-wide QA rules referenced in the root AGENT: rerun `make lint` (or `make lint-fix`), `make test`, and `make coverage MIN_COVERAGE=97` after edits, and update docs when behavior changes.
