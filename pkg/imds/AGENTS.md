...
- Follow the repo-wide QA rules referenced in the root AGENT: rerun `make lint`, `make test`, and `make coverage MIN_COVERAGE=99` after edits, and update docs when behavior changes.
