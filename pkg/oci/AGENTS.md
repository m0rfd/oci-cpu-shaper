...
- Per the repo-wide QA rules (root AGENT), rerun `make lint`, `make test`, and `make coverage MIN_COVERAGE=99` before sending patches and refresh docs when API contracts shift.
