...
- A distinct `make test` job complements the race-enabled coverage target, while the coverage job now posts its summary to the PR via the step summary for fast reviewer feedback on the ≥97% requirement.
