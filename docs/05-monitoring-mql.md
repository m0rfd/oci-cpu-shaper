...
3. Review the built-in panels:
   ...
   - **Controller state timeline** – Uses the `shaper_mode{state="<label>"}` series to highlight transitions between fallback, enforce, and suppressed modes.
